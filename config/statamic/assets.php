...
return [
    ...
    'image_manipulation' => [
        ...
        */
        ...
        /*
         * Cache generated images rather than regenerating them per request. On
         * Webslice the provider repoints cache_path at shared storage and
         * symlinks the route to it, so the cache survives deploys.
         */
        'cache' => true,
